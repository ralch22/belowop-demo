      ...
      <div className="mx-auto max-w-content px-4 py-10 sm:px-6">
        <div className="grid gap-8 sm:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-1 text-sm">
              ...
              <li>
                ...
                >
                  Get instant alerts on WhatsApp <span aria-hidden>→</span>
                </Link>
              </li>
          ...
          <div>
            ...
            {reraReady && (
              <p className="mt-2 text-xs text-slate-600 dark:text-slate-400 max-w-xs">
                RERA broker registration: <span className="font-mono">{process.env.NEXT_PUBLIC_RERA_NUMBER}</span><br />
                Brokerage: <span className="font-mono">{process.env.NEXT_PUBLIC_BROKERAGE_NAME}</span>
              </p>
            )}
